...
<body>
	<form action="allbooks" style="border:1px solid #ccc">
  <div class="container">
    <h1>Sign Up</h1>
    <p>Please fill in this form to create an account.</p>
    <hr>

    <label for="bookId" class="label"><b>Book Id</b></label>
    <input type="text" placeholder="Book Id" name=bookId required>

    <label for="bookName" class="label"><b>Book Name</b></label>
    <input type="text" placeholder="Book Name" name="bookName" required>
    
    <label for="bookPrice" class="label"><b>Book Price</b></label>
    <input type="text" placeholder="Book Price" name="bookPrice" required>
    
    <label for="volume" class="label"><b>Book Volume</b></label>
